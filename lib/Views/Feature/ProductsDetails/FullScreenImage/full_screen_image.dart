        ...
        child: Obx(() => AnimatedOpacity(
          ...
          child: AppBar(
            ...
            actions: [
              ...
              if (controller.isZoomedIn.value)
                IconButton(
                  icon: const Icon(Icons.zoom_out_map,color: AppColors.Black,),
      ...
      body: Obx(() => AnimatedContainer(
        ...
        child: GestureDetector(
          ...
          child: AnimatedSlide(
            ...
            offset: Offset(
              0,
              controller.dragOffset.value / MediaQuery.of(context).size.height,
            ),
            ...
            child: Hero(
              ...
              child: InteractiveViewer(
                ...
                minScale: 0.8,
                maxScale: 6.0,
                onInteractionEnd: (_) => controller.update(),
                child: Center(
                  child: _buildImage(),
                ),
              ),
